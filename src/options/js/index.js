...
const SETTINGS_PREFIX = 'browser-auto-reload.settings';
let downloadUrl = '';
...
function writeSettings(settings) {
  untilInput.checked = settings.until;
  bypassInput.checked = settings.bypass;
...
configForm.addEventListener('submit', function (event) {
  ...
  savedConfig.until = untilInput.checked;
  savedConfig.bypass = bypassInput.checked;
  savedConfig.period = Number.parseInt(periodInput.value, 10);
